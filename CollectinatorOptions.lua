				...
				obtain = {
					...
					args	= {
						...
						crafted = {
							...
							name	= L["Crafted"],
							desc	= L["CRAFTED_DESC"],
							get		= function() return addon.db.profile.filters.obtain.crafted end,
							set		= function() addon.db.profile.filters.obtain.crafted = not addon.db.profile.filters.obtain.crafted end,
						},
						instance = {
							order	= 13,
							type	= "toggle",
						...
						specialevent = {
							order	= 18,
							type	= "toggle",
							name	= L["Special Event"],
							desc	= L["SPECIAL_EVENT_DESC"],
							get		= function() return addon.db.profile.filters.obtain.specialevent end,
							set		= function() addon.db.profile.filters.obtain.specialevent = not addon.db.profile.filters.specialevent.mobdrop end,
						},
						ce = {
							order	= 11,
							type	= "toggle",
				...
				binding = {
					...
					args	= {
						...
						BOE = {
							...
							name	= L["BOEFilter"],
							desc	= L["BOE_DESC"],
							get		= function() return addon.db.profile.filters.binding.boe end,
							set		= function() addon.db.profile.filters.binding.boe = not addon.db.profile.filters.binding.boe end,
						},
						BOP = {
							order	= 4,
							type	= "toggle",
							name	= L["BOPFilter"],
							desc	= L["BOP_DESC"],
							get		= function() return addon.db.profile.filters.binding.bop end,
							set		= function() addon.db.profile.filters.binding.bop = not addon.db.profile.filters.binding.bop end,
						},
						BOA = {
							order	= 5,
							type	= "toggle",
							name	= L["BOAFilter"],
							desc	= L["BOA_DESC"],
							get		= function() return addon.db.profile.filters.binding.boa end,
							set		= function() addon.db.profile.filters.binding.boa = not addon.db.profile.filters.binding.boa end,
						},
					},
				},
--[[
