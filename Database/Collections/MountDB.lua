...
-- Mists of Pandaria
	...
	mount:AddFilters(F.ALLIANCE, F.HORDE, F.IBOP)
	mount:AddZoneLocations(Z.TOWNLONG_STEPPES, nil, nil, "36.6:85.6")
	mount:AddZoneLocations(Z.DREAD_WASTES, nil, nil, "47.2:61.6")
	mount:AddZoneLocations(Z.KUN_LAI_SUMMIT, nil, nil, "75.0:67.6")
	mount:AddZoneLocations(Z.THE_JADE_FOREST, nil, nil, "52.6:19.0")
...
-- Warlords of Draenor
	...
	mount:AddFilters(F.ALLIANCE, F.HORDE, F.IBOP)
	mount:AddZoneLocations(Z.FROSTFIRE_RIDGE, nil, nil, "51.1:19.86", "52.4:18.18", "53.8:17.46")
	mount:AddZoneLocations(Z.NAGRAND_DRAENOR, nil, nil, "40.5:47.6", "44.01:30.67", "57.3:26.7")
	mount:AddZoneLocations(Z.SPIRES_OF_ARAK, nil, nil, "36.43:18.3", "47.0:20.1", "50.4:6.1", "60.8:11.23")
	mount:AddZoneLocations(Z.SHADOWMOON_VALLEY_DRAENOR, nil, nil, "41.9:75.7", "43.2:70.02", "48.7:69.9", "49.6:71.6", "50.9:72.5")
	mount:AddZoneLocations(Z.GORGROND, nil, nil, "51.6:38.8", "54.0:45.8", "56.0:40.7")
	mount:AddZoneLocations(Z.TALADOR, nil, nil, "39.88:55.61", "46.26:52.56", "47.16:48.82", "52.14:41.13")
