...
function addon:InitCritters()
	...
	pet:AddFilters(F.ALLIANCE, F.HORDE, F.SEASONAL, F.IBOP)
	...
	pet:AddFilters(F.ALLIANCE, F.HORDE, F.IBOP, F.QUEST, F.SEASONAL)
	pet:AddQuest(10966, 10967)
	pet:AddSeason("CHILDRENS_WEEK")
	...
	pet:AddFilters(F.ALLIANCE, F.HORDE, F.IBOP, F.VENDOR, F.SEASONAL)
	pet:AddSeason("DARKMOON_FAIRE")
	...
	pet:SetItemID(44810)
	pet:AddFilters(F.ALLIANCE, F.HORDE, F.SEASONAL, F.IBOP, F.ACHIEVEMENT)
	pet:AddAchievement(3478)
	pet:AddSeason("PILGRIMS_BOUNTY")
	-- Crimson Geode -- 62927
	...
	pet:AddFilters(F.ALLIANCE, F.SEASONAL)
	pet:AddVendor(23710)
	pet:AddSeason("BREWFEST")
	-- Jungle Darter -- 62997
	...
	pet:AddFilters(F.HORDE, F.VENDOR)
	pet:AddVendor(8401, 63067)
	-- Frigid Frostling -- 40198
	pet = AddPet(40198, V.WOTLK, Q.RARE)
	pet:AddFilters(F.SEASONAL)
	pet:AddSeason("MIDSUMMER_FIRE_FESTIVAL")
	-- Fawn -- 61165
	...
	pet:AddFilters(F.HORDE, F.SEASONAL)
	pet:AddVendor(32837)
	pet:AddSeason("NOBLEGARDEN")
	...
	pet:AddFilters(F.ALLIANCE, F.HORDE, F.REPUTATION, F.THE_ANGLERS)
