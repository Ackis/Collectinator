...
function addon:InitMob()
	...
	AddMob(60047,	BN.THE_STONE_GUARD,			Z.MOGUSHAN_VAULTS,		0.0, 0.0)
	AddMob(60143,	BN.GARAJAL_THE_SPIRITBINDER,		Z.MOGUSHAN_VAULTS,		0.0, 0.0)
	AddMob(60399,	BN.WILL_OF_THE_EMPEROR,			Z.MOGUSHAN_VAULTS,		0.0, 0.0)
	AddMob(60410,	BN.ELEGON,				Z.MOGUSHAN_VAULTS,		0.0, 0.0)
	AddMob(60491,	BN.SHA_OF_ANGER, 			Z.KUN_LAI_SUMMIT,		67.8, 77.8)
	AddMob(62164,	BN.GARALON,				Z.HEART_OF_FEAR,		0.0,  0.0)
	AddMob(62346,	BB["Galleon"], 				Z.VALLEY_OF_THE_FOUR_WINDS,	70.8, 63.4)
	AddMob(62442,	BN.TSULONG,				Z.TERRACE_OF_ENDLESS_SPRING,	0.0,  0.0)
	AddMob(62543,	BN.BLADE_LORD_TAYAK,			Z.HEART_OF_FEAR,		0.0,  0.0)
	AddMob(62511,	BN.AMBER_SHAPER_UNSOK,			Z.HEART_OF_FEAR,		0.0,  0.0)
	AddMob(62837,	BN.GRAND_EMPRESS_SHEKZEER,		Z.HEART_OF_FEAR,		0.0,  0.0)
	AddMob(62980,	BN.IMPERIAL_VIZIER_ZORLOK,		Z.HEART_OF_FEAR,		0.0,  0.0)
	AddMob(62983,	BN.LEI_SHI,				Z.TERRACE_OF_ENDLESS_SPRING,	0.0,  0.0)
	...
	AddMob(154154,	L["Honey Smasher"],			Z.STORMSONG_VALLEY,		61.4, 15.8)
