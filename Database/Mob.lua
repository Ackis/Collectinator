...
function addon:InitMob()
	...
	AddMob(15276,	BB["Emperor Vek'lor"],			Z.AHNQIRAJ,			61.4, 65.6)
	AddMob(15550,	BB["Attumen the Huntsman"],		Z.KARAZHAN,			 0.0,  0.0)
	AddMob(15952,	BB["Maexxna"],				Z.NAXXRAMAS,			69.8, 14.2)
	AddMob(15263,	BB["The Prophet Skeram"],		Z.AHNQIRAJ,			44.6, 45.6)
	AddMob(16011,	BB["Loatheb"],				Z.NAXXRAMAS,			76.0, 28.4)
