...
function addon:InitVendor()
	...
	AddVendor(63067,	L["Naleen"],			Z.MULGORE,			49.2,	56.0,	"Horde")
	AddVendor(63083,	L["Will Larsons"],		Z.DARKSHORE,			50.2,	20.0,	"Alliance")
	AddVendor(63086,	L["Matty"],			Z.ORGRIMMAR,			37.6,	79.0,	"Horde")
	...
	AddVendor(63626,	L["Varzok"],			Z.ORGRIMMAR,			52.6,	58.8,	"Horde")  -- Blizz thinks this is Varzog
