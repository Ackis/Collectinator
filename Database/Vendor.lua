...
function addon:InitVendor()
	...
	AddVendor(92805,	L["Z'tenga the Walker"],	Z.TANAAN_JUNGLE,		00.0,	00.0,	"Neutral")
	AddVendor(94512,	L["Tiffy Trapspring"],		Z.LUNARFALL,			00.0,	00.0,	"Alliance")
	AddVendor(94516,	L["Giada Goldleash"],		Z.FROSTWALL,			00.0,	00.0,	"Horde")
	...
	AddVendor(95470,	L["Trader Araanda"],		Z.LUNARFALL,			00.0,	00.0,	"Alliance")
