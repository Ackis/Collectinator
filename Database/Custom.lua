...
function addon:InitCustom(DB)
	...
	self:addLookupList(DB, 39, "A rare find from mining Elementium Veins and Rich Elementium Veins")
	...
	self:addLookupList(DB, 57, "Farm mobs within Wetlands for a chance to get this pet")
	self:addLookupList(DB, 58, "Farm whelp mobs within Wetlands, Badlands, and Dustwallow Marsh for a chance to get this pet")
