...
function addon:GetMiniPetTotal(PetDB)
	...
	self:AddCompanionFlags(PetDB, 28505, F_ALLIANCE, F_HORDE, F_SPEC_EVENT, F_REMOVED, 22)
	...
	self:AddCompanionFlags(PetDB, 40405, F_ALLIANCE, F_HORDE, F_SPEC_EVENT, F_REMOVED, 22)
	...
	self:AddCompanionFlags(PetDB, 53082, F_ALLIANCE, F_HORDE, F_BOP)
	...
	self:AddCompanionFlags(PetDB, 54187, F_ALLIANCE, F_HORDE, F_SEASONAL, F_BOP)
	...
	self:AddCompanionFlags(PetDB, 62561, F_ALLIANCE, F_HORDE, F_QUEST, F_BOP)
	...
	self:AddCompanionFlags(PetDB, 66096, F_ALLIANCE, F_HORDE, F_VENDOR, F_BOE)
	self:AddCompanionAcquire(PetDB, 66096, 6, 1094, A_MOB, 34881, 6, 1124, A_MOB, 34772)

	-- Murkimus
	AddPet(63318, 45180, R_UNCOMMON, GAME_WOTLK)
	self:AddCompanionFlags(PetDB, 63318, F_ALLIANCE, F_HORDE, F_SPEC_EVENT, F_PVP, F_BOE)
	self:AddCompanionAcquire(PetDB, 63318, 8, 21)

	-- Heavy Murloc Egg
	AddPet(66030, 45180, R_UNCOMMON, GAME_WOTLK)
	self:AddCompanionFlags(PetDB, 66030, F_ALLIANCE, F_HORDE, F_SPEC_EVENT, F_BOE)
