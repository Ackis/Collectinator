...
Format:
	...
	self:AddCompanion(PetDB, SpellID, Item ID, Rarity, Companion Type)
...
function addon:MakeMiniPetTable(PetDB)
	...
	-- type15.2source4method_craftedskillup75105120135produces44011category11school0reagents4363143591284017742learned75skillEngineeringnameMechanical Squirrelid3928rarity1spellid4055level15methodcraftedid4401item_bindsBOErarity1
	...
	-- type15.2source2spellid10673level20method_vendorsprice400000locs12type7react13descCrazy Cat LadynameDonni Anthaniaminlevel5id6367methodsold-byid8485item_bindsBOErarity1
	...
	-- type15.2source2spellid10674level20method_vendorsprice400000locs12type7react13descCrazy Cat LadynameDonni Anthaniaminlevel5id6367methodsold-byid8486item_bindsBOErarity1
	...
	-- type15.2source1spellid10675level20method_dropslocs130type7disp3590react12classification4lootCount78nameDalaran Spellscribeminlevel21id1920totalLootCount743locs36267maxlevel32type7disp11474react12lootCount108nameDalaran Shield Guardminlevel31id2271totalLootCount131064locs36267maxlevel33type7disp3715react12lootCount69nameDalaran Theurgistminlevel32id2272totalLootCount70640locs36130maxlevel35type7disp3719react12lootCount45nameDalaran Summonerminlevel34id2358totalLootCount67689methoddropped-byid8491item_bindsBOErarity1
	...
	-- type15.2source2spellid10676level20method_vendorsprice400000locs12type7react13descCrazy Cat LadynameDonni Anthaniaminlevel5id6367methodsold-byid8487item_bindsBOErarity1
	...
	-- type15.2source2spellid10678level20method_vendorsprice400000locs12type7react13descCrazy Cat LadynameDonni Anthaniaminlevel5id6367methodsold-byid8488item_bindsBOErarity1
	...
	-- type15.2source2spellid10679level20method_vendorsprice600000locs1519type7react1descBoy with kittensnameLil Timmyminlevel5id8666methodsold-byid8489item_bindsBOErarity1
	...
	-- type15.2source2spellid10680level20method_vendorsprice400000locs33type7react11descPirate SuppliesnameNarkkminlevel42id2663methodsold-byid8496item_bindsBOErarity1
	...
	-- type15.2source13spellid10682level20method_dropslocs33maxlevel41type7react33lootCount10nameBloodsail Raiderminlevel40id1561totalLootCount123352locs33maxlevel41type7react33lootCount7nameBloodsail Mageminlevel40id1562totalLootCount131552locs33maxlevel41type7react33lootCount14nameBloodsail Swashbucklerminlevel40id1563totalLootCount205527locs33maxlevel41type7disp4462react33lootCount5nameBloodsail Warlockminlevel40id1564totalLootCount172813locs33maxlevel42type7disp1768react33lootCount1nameBloodsail Sea Dogminlevel41id1565totalLootCount53112locs33maxlevel42type7disp2558react33lootCount1nameBloodsail Deckhandminlevel41id4505totalLootCount49785locs33maxlevel41type7react33lootCount5nameBloodsail Swabbyminlevel40id4506totalLootCount51269methoddropped-byid8494item_bindsBOErarity1
	...
	-- type15.2source1spellid10683level20method_dropslocs1581maxlevel20type7react33classification1lootCount4427nameDefias Pirateminlevel19id657totalLootCount211160methoddropped-byid8492item_bindsBOErarity1
	...
	-- type15.2source2spellid10684level20method_vendorsprice400000locs33type7react11descPirate SuppliesnameNarkkminlevel42id2663price400000locs3523type7react11descExotic CreaturesnameDealer Rashaadminlevel60id20980methodsold-byid8495item_bindsBOErarity1
	...
	-- type15.2source2spellid10685level35method_vendorsprice1000000locs400type7react11nameMagus Tirthminlevel51id6548methodsold-byid11023item_bindsBOErarity1
	...
	-- Cockroach - 10688
	-- type15.2source2spellid10688level30method_vendorsprice500000locs1497type7react31descCockroach VendornameJeremiah Paysonminlevel30id8403price500000locs3523type7react11descExotic CreaturesnameDealer Rashaadminlevel60id20980methodsold-byid10393item_bindsBOErarity1
	...
	-- type15.2source1spellid10695level30method_dropslocs3maxlevel43type2react33lootCount105nameScalding Whelpminlevel41id2725totalLootCount105585locs152159maxlevel40type2react33lootCount5nameSearing Hatchlingminlevel39id4323totalLootCount96231locs152159maxlevel40type2react33lootCount71nameSearing Whelpminlevel39id4324totalLootCount98175locs152159maxlevel40type1react33lootCount1nameDrywallow Daggermawminlevel39id4345totalLootCount151892methoddropped-byid10822item_bindsBOErarity1
...
--Unknown, 
	...
	-- type15.0source3spellid23012level10methodid18597item_bindsBOPrarity1

	--companioncount = companioncount + 1
	--self:AddCompanion(PetDB, 23012, 18597, 1, "CRITTER")
	--self:AddCompanionFlags(PetDB, 23012, 16)
	-- No acquire information

	-- Human Orphan Whistle - 23013
	-- type15.0source3spellid23013level10methodid18598item_bindsBOPrarity1

	--companioncount = companioncount + 1
	--self:AddCompanion(PetDB, 23013, 18598, 1, "CRITTER")
	--self:AddCompanionFlags(PetDB, 23013, 16)
	-- No acquire information

	-- A Jubling's Tiny Home - 23811
	-- type15.2spellid23811level35methodid19450item_bindsBOPrarity1
	...
	-- type15.0spellid24696level20methodid20371item_bindsBOPrarity3
...
--Unknown, 
	...
	-- type15.2spellid49964level20methodid38050item_bindsBOPrarity3
	...
	-- type15.2source1spellid54187level1method_dropstype15.0rlevel1source3level1lootCount33nameWinter Veil Giftid34426rarity1methodcontained-in-itemid34425item_bindsBOPrarity3
--Unknown, 
	companioncount = companioncount + 1
	...
	-- Penguin Egg - 58636
	-- type15.0spellid58636level20methodid43517item_bindsBOPrarity3
	...
	-- type15.2spellid59250level20methodid43698item_bindsBOPrarity3
	...
	-- type15.0source2spellid61357level20method_vendorsprice12000000locs495type7react11descKalu'ak QuartermasternameTanaikaminlevel65id31916price12000000locs65type7react11descKalu'ak QuartermasternameSairukminlevel65id32763methodsold-byid44723item_bindsBOPrarity3
	...
	-- type15.0spellid61855level1methodid44819item_bindsBOPrarity1
