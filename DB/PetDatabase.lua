...
function addon:MakeMiniPetTable(PetDB)
	...
	AddPet(PetDB, 4055, 4401, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 10673, 8485, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 10674, 8486, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 10675, 8491, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 10676, 8487, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 10677, 8490, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 10678, 8488, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 10679, 8489, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 10680, 8496, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 10682, 8494, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 10683, 8492, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 10684, 8495, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 10685, 11023, R_COMMON, GAME_ORIG)
	...
	-- Cockroach - 10688
	AddPet(PetDB, 10688, 10393, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 10695, 10822, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 10696, 34535, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 10697, 8499, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 10698, 8498, R_COMMON, GAME_ORIG)
	...
	-- Wood Frog Box - 10703
	AddPet(PetDB, 10703, 11027, R_COMMON, GAME_ORIG)
	...
	-- Tree Frog Box - 10704
	AddPet(PetDB, 10704, 11026, R_COMMON, GAME_ORIG)
	...
	-- Hawk Owl - 10706
	AddPet(PetDB, 10706, 8501, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 10707, 8500, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 10709, 10394, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 10711, 8497, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 10714, 10360, R_COMMON, GAME_ORIG)
	...
	-- Brown Snake - 10716
	AddPet(PetDB, 10716, 10361, R_COMMON, GAME_ORIG)
	...
	-- Crimson Snake - 10717
	AddPet(PetDB, 10717, 10392, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 12243, 10398, R_COMMON, GAME_ORIG)
	...
	-- Chicken Egg - 13548
	AddPet(PetDB, 13548, 11110, R_COMMON, GAME_ORIG)
	...
	-- Pet Bombling - 15048
	AddPet(PetDB, 15048, 11825, R_COMMON, GAME_ORIG)
	...
	-- Lil' Smoky - 15049
	AddPet(PetDB, 15049, 11826, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 15067, 11474, R_COMMON, GAME_ORIG)
	...
	-- Worg Carrier - 15999
	AddPet(PetDB, 15999, 12264, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 16450, 12529, R_COMMON, GAME_ORIG)
	...
	-- Panda Collar - 17707
	AddPet(PetDB, 17707, 13583, R_RARE, GAME_ORIG)
	...
	-- Diablo Stone - 17708
	AddPet(PetDB, 17708, 13584, R_RARE, GAME_ORIG)
	...
	AddPet(PetDB, 17709, 13582, R_RARE, GAME_ORIG)
	...
	AddPet(PetDB, 19772, 15996, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 23811, 19450, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 24696, 20371, R_RARE, GAME_ORIG)
	...
	-- Lurky's Egg - 24988
	AddPet(PetDB, 24988, 30360, R_RARE, GAME_ORIG)
	...
	AddPet(PetDB, 25162, 20769, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 26010, 21277, R_COMMON, GAME_ORIG)
	...
	-- Snowman Kit - 26045
	AddPet(PetDB, 26045, 21309, R_COMMON, GAME_ORIG)
	...
	-- Jingling Bell - 26529
	AddPet(PetDB, 26529, 21308, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 26533, 21301, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 26541, 21305, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 27241, 22114, R_RARE, GAME_ORIG)
	...
	AddPet(PetDB, 27570, 22235, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 28505, 22781, R_COMMON, GAME_ORIG)
	...
	-- Turtle Box - 28738
	AddPet(PetDB, 28738, 23002, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 28739, 23007, R_COMMON, GAME_ORIG)
	...
	-- Rat Cage - 28740
	AddPet(PetDB, 28740, 23015, R_COMMON, GAME_ORIG)
	...
	AddPet(PetDB, 28871, 23083, R_RARE, GAME_ORIG)
	...
	AddPet(PetDB, 30156, 23713, R_EPIC, GAME_TBC)
	...
	AddPet(PetDB, 32298, 25535, R_RARE, GAME_TBC)
	...
	AddPet(PetDB, 33050, 27445, R_COMMON, GAME_TBC)
	...
	-- Mana Wyrmling - 35156
	AddPet(PetDB, 35156, 29363, R_COMMON, GAME_TBC)
	...
	AddPet(PetDB, 35239, 29364, R_COMMON, GAME_ORIG)
	...
	-- Blue Moth Egg - 35907
	AddPet(PetDB, 35907, 29901, R_COMMON, GAME_TBC)
	...
	-- Red Moth Egg - 35909
	AddPet(PetDB, 35909, 29902, R_COMMON, GAME_TBC)
	...
	AddPet(PetDB, 35910, 29903, R_COMMON, GAME_TBC)
	...
	AddPet(PetDB, 35911, 29904, R_COMMON, GAME_TBC)
	...
	AddPet(PetDB, 36027, 29953, R_COMMON, GAME_TBC)
	...
	AddPet(PetDB, 36028, 29956, R_COMMON, GAME_TBC)
	...
	AddPet(PetDB, 36029, 29957, R_COMMON, GAME_TBC)
	...
	AddPet(PetDB, 36031, 29958, R_COMMON, GAME_TBC)
	...
	AddPet(PetDB, 36034, 29960, R_COMMON, GAME_TBC)
	...
	-- Miniwing - 39181
	AddPet(PetDB, 39181, 31760, R_COMMON, GAME_TBC)
	...
	AddPet(PetDB, 39709, 32233, R_RARE, GAME_TBC)
	...
	AddPet(PetDB, 40405, 32498, R_RARE, GAME_TBC)
	...
	-- Banana Charm - 40549
	AddPet(PetDB, 40549, 32588, R_RARE, GAME_TBC)
	...
	-- Sleepy Willy - 40613
	AddPet(PetDB, 40613, 32617, R_RARE, GAME_TBC)
	...
	-- Egbert's Egg - 40614
	AddPet(PetDB, 40614, 32616, R_RARE, GAME_TBC)
	...
	AddPet(PetDB, 40634, 32622, R_RARE, GAME_TBC)
	...
	AddPet(PetDB, 40990, 40653, R_RARE, GAME_TBC)
	...
	AddPet(PetDB, 42609, 33154, R_RARE, GAME_TBC)
	...
	AddPet(PetDB, 43697, 33816, R_RARE, GAME_TBC)
	...
	AddPet(PetDB, 43698, 33818, R_RARE, GAME_TBC)
	...
	-- Mojo - 43918
	AddPet(PetDB, 43918, 33993, R_RARE, GAME_TBC)
	...
	-- Tiny Sporebat - 45082
	AddPet(PetDB, 45082, 34478, R_RARE, GAME_TBC)
	...
	AddPet(PetDB, 45125, 34492, R_RARE, GAME_TBC)
	...
	-- Dragon Kite - 45127
	AddPet(PetDB, 45127, 34493, R_EPIC, GAME_TBC)
	...
	AddPet(PetDB, 45890, 34955, R_RARE, GAME_TBC)
	...
	AddPet(PetDB, 46425, 35349, R_RARE, GAME_TBC)
	...
	AddPet(PetDB, 46426, 35350, R_RARE, GAME_TBC)
	...
	AddPet(PetDB, 46599, 35504, R_RARE, GAME_TBC)
	...
	AddPet(PetDB, 48406, 37297, R_UNCOMMON, GAME_TBC)
	...
	AddPet(PetDB, 48408, nil, R_UNCOMMON, GAME_TBC)
	...
	AddPet(PetDB, 49964, 38050, R_RARE, GAME_TBC)
	...
	AddPet(PetDB, 51716, 38628, R_RARE, GAME_TBC)
	...
	AddPet(PetDB, 51851, 38658, R_RARE, GAME_TBC)
	...
	AddPet(PetDB, 52615, 39286, R_RARE, GAME_WOTLK)
	...
	-- Tyrael's Hilt - 53082
	AddPet(PetDB, 53082, 39656, R_RARE, GAME_TBC)
	...
	-- Ghostly Skull - 53316
	AddPet(PetDB, 53316, 39973, R_RARE, GAME_WOTLK)
	...
	AddPet(PetDB, 54187, 34425, R_RARE, GAME_WOTLK)
	...
	-- Penguin Egg - 58636
	--AddPet(PetDB, 58636, 43517, R_RARE, GAME_WOTLK)
	...
	AddPet(PetDB, 59250, 43698, R_RARE, GAME_WOTLK)
	...
	AddPet(PetDB, 61348, 39896, R_COMMON, GAME_WOTLK)
	...
	AddPet(PetDB, 61349, 39899, R_COMMON, GAME_WOTLK)
	...
	AddPet(PetDB, 61350, 44721, R_COMMON, GAME_WOTLK)
	...
	AddPet(PetDB, 61351, 39898, R_COMMON, GAME_WOTLK)
	...
	AddPet(PetDB, 61357, 44723, R_RARE, GAME_WOTLK)
	...
	AddPet(PetDB, 61472, 44738, R_RARE, GAME_WOTLK)
	...
	AddPet(PetDB, 61855, 44819, R_COMMON, GAME_WOTLK)
	...
	-- Spring Rabbit - 61725
	AddPet(PetDB, 61725, 44794, R_COMMON, GAME_WOTLK)
	...
	-- Little Fawn - 61991
	AddPet(PetDB, 61991, 44841, R_COMMON, GAME_WOTLK)
	...
	AddPet(PetDB, 62562, 44984, R_UNCOMMON, GAME_WOTLK)
	...
	AddPet(PetDB, 62508, 44970, R_UNCOMMON, GAME_WOTLK)
	...
	-- Elwynn Lamb -- 62516
	AddPet(PetDB, 62516, 44974, R_UNCOMMON, GAME_WOTLK)
	...
	-- Mechanopeep -- 62674
	AddPet(PetDB, 62674, 45002, R_UNCOMMON, GAME_WOTLK)
	...
	AddPet(PetDB, 62491, 44965, R_UNCOMMON, GAME_WOTLK)
	...
	AddPet(PetDB, 62513, 44973, R_UNCOMMON, GAME_WOTLK)
	...
	AddPet(PetDB, 62564, 44982, R_UNCOMMON, GAME_WOTLK)
	...
	AddPet(PetDB, 62542, 44980, R_UNCOMMON, GAME_WOTLK)
	...
	AddPet(PetDB, 63712, 45606, R_UNCOMMON, GAME_WOTLK)
	...
	AddPet(PetDB, 62510, 44971, R_UNCOMMON, GAME_WOTLK)
	...
	AddPet(PetDB, 62561, 44983, R_COMMON, GAME_WOTLK)
	...
	-- Argent Squire -- 62609
	AddPet(PetDB, 62609, 44998, R_COMMON, GAME_WOTLK)
	...
	AddPet(PetDB, 62746, 45022, R_COMMON, GAME_WOTLK)
	...
	AddPet(PetDB, 66096, 46820, R_UNCOMMON, GAME_WOTLK)
	...
	-- Murkimus
	AddPet(PetDB, 63318, 45180, R_UNCOMMON, GAME_WOTLK)
	...
	-- Heavy Murloc Egg
	AddPet(PetDB, 66030, 45180, R_UNCOMMON, GAME_WOTLK)
	...
	-- Darting Hatchling
	AddPet(PetDB, 67413, 48112, R_COMMON, GAME_WOTLK)
	...
	-- Deviate Hatchling
	AddPet(PetDB, 67414, 48114, R_COMMON, GAME_WOTLK)
	...
	-- Gundrak Hatchling
	AddPet(PetDB, 67415, 48116, R_COMMON, GAME_WOTLK)
	...
	-- Leaping Hatchling
	AddPet(PetDB, 67416, 48118, R_COMMON, GAME_WOTLK)
	...
	-- Obsidian Hatchling
	AddPet(PetDB, 67417, 48120, R_COMMON, GAME_WOTLK)
	...
	-- Ravasaur Hatchling
	AddPet(PetDB, 67418, 48122, R_COMMON, GAME_WOTLK)
	...
	-- Razormaw Hatchling
	AddPet(PetDB, 67419, 48124, R_COMMON, GAME_WOTLK)
	...
	-- Razzashi Hatchling
	AddPet(PetDB, 67420, 48122, R_COMMON, GAME_WOTLK)
	...
	AddPet(PetDB, 65381, 46545, R_UNCOMMON, GAME_WOTLK)
	...
	-- Curious Wolvar Pup
	AddPet(PetDB, 65382, 46544, R_UNCOMMON, GAME_WOTLK)
	...
	-- Battle-Bot
	AddPet(PetDB, 65682, 46767, R_UNCOMMON, GAME_WOTLK)
