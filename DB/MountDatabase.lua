...
-- PLAYERMADE
	...
	if MY_FACTION == FACTION_HORDE then
		...
		self:AddCompanionFlags(DB, 60119, F_HORDE, F_ACHIEVEMENT, F_BOP)
		...
		self:AddCompanionFlags(DB, 64657, F_HORDE, F_VENDOR, F_BOP)
		...
		self:AddCompanionFlags(DB, 63635, F_HORDE, F_VENDOR, F_BOP, F_CITY1)
		...
		self:AddCompanionFlags(DB, 63640, F_HORDE, F_VENDOR, F_BOP, F_CITY2)
		...
		self:AddCompanionFlags(DB, 63641, F_HORDE, F_VENDOR, F_BOP, F_CITY3)
		...
		self:AddCompanionFlags(DB, 63643, F_HORDE, F_VENDOR, F_BOP, F_CITY4)
		...
		self:AddCompanionFlags(DB, 63642, F_HORDE, F_VENDOR, F_BOP, F_CITY5)
	...
	elseif MY_FACTION == FACTION_ALLIANCE then
		...
		self:AddCompanionFlags(DB, 60118, F_ALLIANCE, F_ACHIEVEMENT, F_BOP)
		...
		self:AddCompanionFlags(DB, 59785, F_ALLIANCE, F_VENDOR, F_BOP, F_PVP)
		...
		self:AddCompanionFlags(DB, 22720, F_ALLIANCE, F_VENDOR, F_BOP, F_PVP)
		...
		self:AddCompanionFlags(DB, 22723, F_ALLIANCE, F_VENDOR, F_BOP, F_PVP)
		self:AddCompanionAcquire(DB, 22723, A_VENDOR, 12783)

		-- Reins of the Black War Elekk - 48027
		AddMount(48027, 35906, R_EPIC, GAME_BC)
		self:AddCompanionFlags(DB, 48027, F_ALLIANCE, F_VENDOR, F_BOP, F_PVP)
		...
		self:AddCompanionFlags(DB, 63637, F_ALLIANCE, F_VENDOR, F_BOP, F_CITY1)
		...
		self:AddCompanionFlags(DB, 63232, F_ALLIANCE, F_VENDOR, F_BOP, F_CITY2)
		...
		self:AddCompanionFlags(DB, 63638, F_ALLIANCE, F_VENDOR, F_BOP, F_CITY3)
		...
		self:AddCompanionFlags(DB, 63636, F_ALLIANCE, F_VENDOR, F_BOP, F_CITY4)
		...
		self:AddCompanionFlags(DB, 63639, F_ALLIANCE, F_VENDOR, F_BOP, F_CITY5)
	...
	self:AddCompanionFlags(DB, 39316, F_ALLIANCE, F_HORDE, F_VENDOR, F_BOP, F_NAGRAND, F_PVP)
...
--DROP
	...
	self:AddCompanionFlags(DB, 59569, F_ALLIANCE, F_HORDE, F_MOB_DROP, F_INSTANCE, F_BOP)
	...
	self:AddCompanionFlags(DB, 61294, F_ALLIANCE, F_HORDE, F_VENDOR, F_BOP, F_ORACLES)
...
--REP VENDOR NEUTRAL
	...
	self:AddCompanionFlags(DB, 43927, F_ALLIANCE, F_HORDE, F_VENDOR, F_BOP, F_CENARION_EXPEDITION)
	...
	self:AddCompanionFlags(DB, 39315, F_ALLIANCE, F_HORDE, F_VENDOR, F_BOP, F_NAGRAND)
	...
	self:AddCompanionFlags(DB, 39317, F_ALLIANCE, F_HORDE, F_VENDOR, F_BOP, F_NAGRAND)
	...
	self:AddCompanionFlags(DB, 39318, F_ALLIANCE, F_HORDE, F_VENDOR, F_BOP, F_NAGRAND)
	...
	self:AddCompanionFlags(DB, 39319, F_ALLIANCE, F_HORDE, F_VENDOR, F_BOP, F_NAGRAND)
	...
	self:AddCompanionFlags(DB, 34896, F_ALLIANCE, F_HORDE, F_VENDOR, F_BOP, F_NAGRAND)
	...
	self:AddCompanionFlags(DB, 34897, F_ALLIANCE, F_HORDE, F_VENDOR, F_BOP, F_NAGRAND)
	...
	self:AddCompanionFlags(DB, 34898, F_ALLIANCE, F_HORDE, F_VENDOR, F_BOP, F_NAGRAND)
