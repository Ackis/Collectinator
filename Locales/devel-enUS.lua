...
L["SPECTRAL_SPIDERS"] = "Purchase the 'Creepy Crawlers' decoration from the vendor in your Garrison, use it, and then kill the rare spawn in your Garrison named Arachnis. If the toy isn't in the loot window, don't loot, and wait for respawn in 5 minutes."
